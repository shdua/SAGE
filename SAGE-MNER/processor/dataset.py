...
class MMPNERProcessor(object):
    def __init__(self, data_path, bert_name) -> None:
        ...
        print("Loading tokenizer from:", bert_name)
        #self.tokenizer = BertTokenizer.from_pretrained(bert_name, local_files_only=True)
        self.tokenizer = XLMRobertaTokenizer.from_pretrained(bert_name, local_files_only=True)
    ...
    def load_from_file(self, mode="train"):
        ...
        with open(load_file, "r", encoding="utf-8") as f:
            ...
            for line in lines:
                ...
                if line != "\n":
                    ...
                    if len(parts) > 1:
                        ...
                        print(f"Warning: Line does not contain a label or is improperly formatted - {line}")
            ...
            print("Number of word lists:", len(raw_words))
            print("Number of target lists:", len(raw_targets))
...
class PadCollate:
    ...
    def pad_collate(self, batch):
        ...
        if 'token_type_ids' not in batch_tokens:
            batch_tokens['token_type_ids'] = torch.zeros_like(batch_tokens['input_ids'])
